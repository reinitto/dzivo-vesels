            ...
            <div>
              <div className="row-page row">
                <div className="col-page col-sm-8 col-md-6">
                  <Link to="/Article1" className="black fondo-publicacion-home">
                ...
                <div className="col-page col-sm-4 col-md-3 ">
                  <Link to="/Article3" className="fondo-publicacion-home">
                    <div className="img-publicacion-home">
                ...
                <div className="col-page col-sm-4 ">
                  <Link to="/Article4" className="fondo-publicacion-home">
                    <div className="img-publicacion-home">
                ...
                <div className="hidden-sm col-page col-sm-4 ">
                  <Link to="/Article5" className="fondo-publicacion-home">
                    <div className="img-publicacion-home">
                ...
                <div className="hidden-sm col-page col-sm-4 ">
                  <Link to="/Article6" className="fondo-publicacion-home">
                    <div className="img-publicacion-home">
                ...
                <div className="col-page col-sm-4 ">
                  <Link to="/Article7" className="fondo-publicacion-home">
                    <div className="img-publicacion-home">
                ...
                <div className="col-page col-sm-4 ">
                  <Link to="/Forma" className="fondo-publicacion-home">
                    <div className="img-publicacion-home">
                ...
                <div className="col-page col-sm-4 ">
                  <Link to="/About" className="fondo-publicacion-home">
                    <div className="img-publicacion-home">
                ...
                <div className="col-page col-sm-4 ">
                  <Link to="/Monitors" className="fondo-publicacion-home">
                    <div className="img-publicacion-home">
